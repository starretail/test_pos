dhtmlxEvent(window,"load",function(){    	
	...
	mygrid.setHeader("Id,Origin,Delievery To,Delivery No,Deliver Date,Item,Qty Delivered,Qty Received,Status"); 
	mygrid.attachHeader(",#select_filter_strict,#select_filter_strict,#text_filter,#text_filter,#select_filter_strict,,,#select_filter_strict"); 
